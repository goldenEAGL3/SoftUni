...
public abstract class BaseCard implements Card {
    private static final int CARD_HEALTH_POINTS_MIN = 0;
    private static final int CARD_DAMAGE_POINTS_MIN = 0;
    ...
    public void setDamagePoints(int damagePoints) {
        if (damagePoints < CARD_DAMAGE_POINTS_MIN) {
    ...
    private void setHealthPoints(int healthPoints) {
        if (healthPoints < CARD_HEALTH_POINTS_MIN) {
