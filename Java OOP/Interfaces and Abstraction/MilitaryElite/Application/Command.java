...
import InterfacesAndAbstractions.MilitaryElite.Common.MissionImpl;
import InterfacesAndAbstractions.MilitaryElite.Common.RepairImpl;
import InterfacesAndAbstractions.MilitaryElite.enumerations.Corps;
import InterfacesAndAbstractions.MilitaryElite.enumerations.State;
...
import InterfacesAndAbstractions.MilitaryElite.models.*;
...
public class Command {
    ...
    public void execute(String command, List<String> tokens) {
        ...
        if (command.equals("Private")) {
            ...
            if (Corps.Airforces.toString().equals(corps) || Corps.Marines.toString().equals(corps)) {
                soldier = new EngineerImpl(id, firstName, lastName,
                        Double.parseDouble(tokens.get(3)), Corps.valueOf(corps));
