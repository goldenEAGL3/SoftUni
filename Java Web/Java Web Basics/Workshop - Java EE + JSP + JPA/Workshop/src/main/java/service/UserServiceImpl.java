...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserServiceModel register(String username, String password, String confirmPassword, String email) {
        if (!validationService.passwordMatches(password, confirmPassword) ||
