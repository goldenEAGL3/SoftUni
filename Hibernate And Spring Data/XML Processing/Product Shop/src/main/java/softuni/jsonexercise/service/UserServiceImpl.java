...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void seedUsers(UserSeedModelViewWrapper userSeedDTO) {

        for (UserSeedDTO seedDTO : userSeedDTO.getUsers()) {
    ...
    public UsersWithAtLeastOneProductSoldModelViewWrapper getAllUsersWithAtLeastOneProductSold() {
        ...
        UsersWithAtLeastOneProductSoldModelViewWrapper user = new UsersWithAtLeastOneProductSoldModelViewWrapper(usersDto);
        return user;
    }
