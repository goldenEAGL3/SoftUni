...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public void seedCategories(CategorySeedModelViewWrapper categorySeedDTOS) {
        for (CategorySeedDTO seedDTO : categorySeedDTOS.getCategory()) {
    ...
    @Override
    public CategoryModelViewWrapper getAllCategories() {
        ...
        CategoryModelViewWrapper categoryDto = new CategoryModelViewWrapper(categories);
        return categoryDto;
    }
