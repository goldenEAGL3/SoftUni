...
public class SaleServiceImpl implements SaleService {
    ...
    @Override
    public SalesWithAppliedDiscountModelViewWrapper getAllSalesWithAppliedDiscount() {
        ...
        SalesWithAppliedDiscountModelViewWrapper salesResult = new SalesWithAppliedDiscountModelViewWrapper();
        salesResult.setSales(sales);
        return salesResult;
    }
